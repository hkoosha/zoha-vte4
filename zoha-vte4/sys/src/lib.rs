...
pub type VteTerminalSpawnAsyncCallback =
    Option<unsafe extern "C" fn(*mut VteTerminal, glib::ffi::GPid, *mut glib::ffi::GError, gpointer)>;
...
pub struct VteTerminalClass {
    pub parent_class: gtk4_sys::GtkWidgetClass,
...
extern "C" {
    ...
    pub fn vte_pty_error_quark() -> glib::ffi::GQuark;

    //=========================================================================
    // VteRegexError
    //=========================================================================
    pub fn vte_regex_error_get_type() -> GType;
    pub fn vte_regex_error_quark() -> glib::ffi::GQuark;
    ...
    pub fn vte_pty_spawn_async(
        ...
        argv: *mut *mut c_char,
        envv: *mut *mut c_char,
        spawn_flags: glib::ffi::GSpawnFlags,
        child_setup: glib::ffi::GSpawnChildSetupFunc,
        child_setup_data: gpointer,
        child_setup_data_destroy: glib::ffi::GDestroyNotify,
        timeout: c_int,
        cancellable: *mut gio_sys::GCancellable,
    ...
    pub fn vte_terminal_get_text(
        ...
        user_data: gpointer,
        attributes: *mut glib::ffi::GArray,
    ) -> *mut c_char;
    ...
    pub fn vte_terminal_set_color_background(
        terminal: *mut VteTerminal,
        background: *const gdk4_sys::GdkRGBA,
    );
    pub fn vte_terminal_set_color_bold(terminal: *mut VteTerminal, bold: *const gdk4_sys::GdkRGBA);
    pub fn vte_terminal_set_color_cursor(
        terminal: *mut VteTerminal,
        cursor_background: *const gdk4_sys::GdkRGBA,
    );
    pub fn vte_terminal_set_color_cursor_foreground(
        terminal: *mut VteTerminal,
        cursor_foreground: *const gdk4_sys::GdkRGBA,
    );
    pub fn vte_terminal_set_color_foreground(
        terminal: *mut VteTerminal,
        foreground: *const gdk4_sys::GdkRGBA,
    );
    pub fn vte_terminal_set_color_highlight(
        terminal: *mut VteTerminal,
        highlight_background: *const gdk4_sys::GdkRGBA,
    );
    pub fn vte_terminal_set_color_highlight_foreground(
        terminal: *mut VteTerminal,
        highlight_foreground: *const gdk4_sys::GdkRGBA,
    );
    pub fn vte_terminal_set_colors(
        terminal: *mut VteTerminal,
        foreground: *const gdk4_sys::GdkRGBA,
        background: *const gdk4_sys::GdkRGBA,
        palette: *const gdk4_sys::GdkRGBA,
        palette_size: size_t,
    );
    ...
    pub fn vte_terminal_set_font(
        terminal: *mut VteTerminal,
        font_desc: *const pango_sys::PangoFontDescription,
    );
    ...
    pub fn vte_terminal_watch_child(terminal: *mut VteTerminal, child_pid: glib::ffi::GPid);
    pub fn vte_terminal_write_contents_sync(
        terminal: *mut VteTerminal,
        stream: *mut gio_sys::GOutputStream,
        flags: VteWriteFlags,
        cancellable: *mut gio_sys::GCancellable,
        error: *mut *mut glib::ffi::GError,
    ) -> gboolean;
